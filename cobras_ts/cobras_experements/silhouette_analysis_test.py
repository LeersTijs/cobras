...
def determine_split_level_using_silhouette():
    pass


def determine_split_level_using_elbow():
    pass
...
def _test():
    ...
    # kneedle = KneeLocator(range_n_clusters, avg_silhouette_scores, curve="")
